        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="space-y-4 max-w-4xl">
            ...
            <p className="text-slate-600 text-base sm:text-lg font-normal leading-relaxed font-sans">
              Self-paced training with step-by-step lessons, action guides, and a downloadable Route K9 completion certificate. $49 one-time — lifetime access.
            </p>

          </div>

          {/* 6 Image Background Course Cards Grid */}
            ...
            {COURSES_DATA.map((course) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Top Content: Number Badge & Titles */}
                  <div className="relative z-10 space-y-4">
                    ...
                    {/* Course Title & High-Impact Subtitle */}
                    <div className="space-y-2">
                      ...
                      <p className="text-xs font-semibold text-rose-300 leading-relaxed font-sans">
                        {course.subtitle}
                      </p>
                    </div>
                  ...
                  <div className="relative z-10 pt-6 border-t border-white/15 flex items-center justify-between mt-auto">
